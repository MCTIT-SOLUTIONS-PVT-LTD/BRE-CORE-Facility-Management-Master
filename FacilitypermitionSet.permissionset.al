...
permissionset 51000 FacilitypermitionSet
{
    ...
    Permissions = report "Asset QR-Code Report" = X,
        ...
        page "Facility Vendor Profile List" = X,
        page "FM Service Request Card" = X,
        page "FM Service Request List" = X,
        page "OEM Master Card" = X,
        ...
        page "Sub-Equipment Card" = X,
        page "Sub-Equipment List" = X,
